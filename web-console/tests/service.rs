...
async fn work_snapshot_is_available_through_a_read_request() {
    ...
    .unwrap();
    assert!(body.starts_with(r#"{"state":"fresh","value":{"claimed":[],"planned":[],"being_planned":[],"ux_agreed":[],"unplanned":[],"paused":[],"merged":[],"linked":[],"assignable":[],"bugfixable":[],"second_look":[],"candidates":{},"epics":{}},"updated_at":""#));
    ...
    .unwrap();
    assert!(body.starts_with(r#"{"state":"stale","value":{"claimed":[],"planned":[],"being_planned":[],"ux_agreed":[],"unplanned":[],"paused":[],"merged":[],"linked":[],"assignable":[],"bugfixable":[],"second_look":[],"candidates":{},"epics":{}},"error":"could not run "#));
}
