---
name: build-design
description: The build-design session - turns a piece of work whose experience is already agreed into a plan an implementer can build unattended. Reads the agreed design and the mockup, decides the architecture, the files, the increments, the tests and the verification itself, files the plan and says what it decided. Written for a software developer, and it may assume the whole of this repository. Started by `.cerebro/cerebro/scripts/launch <Name>`, and interactive by design.
---
