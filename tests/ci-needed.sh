...
for p in .github/workflows/ci.yml scripts/ci-needed tests/gate agents/ux.md \
         skills/design-the-build/SKILL.md templates/consumer-instructions.md CLAUDE.md \
