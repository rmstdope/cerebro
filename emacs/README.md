...
showing every agent — Xavier, Cerebro, Moira, Psylocke, Forge and the thirteen implementers — with its
state, and for one working a bead (an implementer, or since ah-2n3.2 one of the interactive five
