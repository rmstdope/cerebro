...
add(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}" '
    f'role="img" aria-label="The Cerebro fleet: the humans it answers to, nine agent roles, the bead board and the fleet view">')
add("<defs>")
...
text(930, 186, "nine agent roles, one bead board, and the humans they answer to",
