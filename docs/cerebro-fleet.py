...
add(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}" '
    f'role="img" aria-label="The Cerebro fleet: the humans it answers to, eight agent roles, the bead board and the fleet view">')
add("<defs>")
...
text(930, 186, "eight agent roles, one bead board, and the humans they answer to",
...
PAIRS = [
    ...
    (462, "PRODUCT MANAGER", CRIMSON, "roadmap", "XAVIER + BEAST", "UX", CRIMSON, "#8c1226", "X",
...
CARDS = [
    ...
    ("UX AGREED", "ready to produce", CRIMSON + "33"),
    ("CLAIMED", "a producer has it", "#cfe0f7"),
...
text(SX + SW // 2, SY + 50, "THE PRODUCERS  ×12", size=27, fill="#fff", spacing=1)
...
for i, (nm, col) in enumerate(SQUAD):
    ...
    add("</g>")
text(SX + SW // 2, SY + 392, "claim one UX-agreed bead · design and build it test-first",
...
arrow(f"M{AX+66},480 C700,480 730,430 {BX-8},420", CRIMSON, 6, "agreed experience", 700, 452)
...
arrow(f"M{BX+BW+8},520 C1150,520 1160,440 {SX-8},440", GOLD, 7, "claim + produce", 1160, 480)
